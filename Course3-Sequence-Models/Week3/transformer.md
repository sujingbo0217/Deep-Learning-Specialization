    ...
    def _fast_decode_tpu(self,
        ...
        def symbols_to_logits_tpu_fn(ids, i, cache):
            ...
            with tf.variable_scope(modality_name):
                ...
                logits = dp(top, body_outputs, None,
                            hparams, target_vocab_size)[0]
    ...
    def _fast_decode(self,
        ...
        def symbols_to_logits_fn(ids, i, cache):
            ...
            if partial_targets is not None:
                ...
                def forced_logits():
                    return tf.one_hot(
                        tf.tile(partial_targets[:, i], [
                                beam_size]), vocab_size, 0.0,
                        -1e9)
...
class TransformerScorer(Transformer):
    ...
    def infer(self,
        ...
        log_probs = common_layers.index_last_dim_with_indices(
            log_probs, targets)
    ...
    def __init__(self, *args, **kwargs):
        ...
        for layer in range(hparams.num_decoder_layers or hparams.num_hidden_layers):
            ...
            if hparams.memory_type == "neural_memory":
                ...
                raise ValueError("Unsupported memory type: %s" %
                                 hparams.memory_type)
